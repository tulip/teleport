...
- Teleport version `v7.0` or newer.
- MongoDB cluster (standalong or replica set) version `v3.6` or newer.

<Admonition type="note">
  Teleport Database Access supports MongoDB 3.6 and newer. Older versions have
...
when connecting toa MongoDB instance. Users authenticating with client certificates
