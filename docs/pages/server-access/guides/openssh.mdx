...
Now you can use [`tsh ssh --port=22 user@api.example.com`](../../reference/cli-docs.mdx#tsh) to login
...
>
  If you use [recording proxy mode](../../architecture/proxy.mdx) and [trusted clusters](../../architecture/trustedclusters.mdx),
