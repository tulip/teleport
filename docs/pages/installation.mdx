...
Teleport core service [`teleport`](reference/cli-docs.mdx#teleport) and admin tool [`tctl`](reference/cli-docs.mdx#tctl) have been designed to run on **Linux** and **Mac** operating systems. The Teleport user client [`tsh`](reference/cli-docs.mdx#tsh) and UI are available for **Linux, Mac**, and **Windows** operating systems.
