...
## Step 1/3. Start teleport demo lab
...
docker-compose -f teleport-lab.yml up
```
...
## Step 2/3. Explore teleport using CLI
...
## Step 3/3. Explore teleport using web UI
...
# Export host CA for SSH client to trust.
